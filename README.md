...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    Describe breaks up test into individual components. you use it to perform individual tests.
1. What is the point of `Test Driven Development`? What do you think about this approach?
    I think it's a good approach when you test before you run a function. It's easier to write clean code.
